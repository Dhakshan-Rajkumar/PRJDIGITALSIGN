...
Public Class FrmTemplateBrouchersRecords
    Public Sub loaddata()
        ds = New DataSet
        con = New OleDbConnection(GetConnection("Eprojects"))

        com.CommandText = "select Temp_Code, Temp_name, Temp_type, Temp_location, Duration, ratepermts from Template_Master where Temp_type='BROUCHERS'  "
    ...
    Private Sub dgv_CellDoubleClick(sender As System.Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv.CellDoubleClick
        ...
        Try
            ...
            If Me.dgv.CurrentRow.Cells(2).Value = "BROUCHERS" Or Me.dgv.CurrentRow.Cells(2).Value = "brouchers" Then
                Dim cus As FrmTemplateBrouchersdisplay = New FrmTemplateBrouchersdisplay()
